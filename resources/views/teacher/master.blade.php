...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('teacher') }}">
            ...
            <li class="nav-item {{ Request::is('teacher/student') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('teacher.student') }}">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Kelas Perwalian</span></a>
            </li>
            ...
            <li class="nav-item {{ Request::is('teacher/presence') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('teacher.presence') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Budi Santoso</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('teacher.setting') }}">
