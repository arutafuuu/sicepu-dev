                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h4 mb-0 font-weight-bold text-gray-800">84,67</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">Siswa terpantau sangat baik dalam sains. Namun, perlu peningkatan lebih di olahraga</div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-12 col-lg-7">
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Grafik nilai rata-rata persemester</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
